...
- (void)layoutSubviews {
    ...
    self.centerButton.center = CGPointMake(CGRectGetWidth(self.bounds) * 0.5, CGRectGetWidth(self.bounds) * 0.5);
...
- (void)setLoadProgress:(CGFloat)loadProgress {
    ...
    self.animatedLayer.strokeEnd = loadProgress;
    !self.progressChange ? : self.progressChange(self, loadProgress);
